...
export default function Home() {
  ...
  const objects = urls.map(name => {
    const url = `http://www.apimeme.com/thumbnail?name=${name}`
  ...
  return (
    <>
      ...
      <main>
        <Hero />
        <br/>
          <Row className="g-8 pb-2">
            {objects?.map((meme) => (
            <Col className="pb-2" key={meme?.name}>
              <MemeCard key={meme?.name} url={meme?.url} name={meme?.name}/>
            </Col>
            ))}
          </Row>
      </main>
